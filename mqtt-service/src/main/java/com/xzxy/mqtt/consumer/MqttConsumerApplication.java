...
@ComponentScan(basePackages = {"com.mateam.mqtt","com.xzxy.mqtt"})
@EnableAutoConfiguration
public class MqttConsumerApplication {

    Logger logger = LoggerFactory.getLogger(MqttConsumerApplication.class);
    ...
    public static void main(String[] args) throws Exception {
        SpringApplication.run(MqttConsumerApplication.class);
    }
